...
RSpec.describe "/shops", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get shops_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Shop" do
        expect {
          post shops_url,
               params: { shop: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Shop" do
        expect {
          post shops_url,
               params: { shop: invalid_attributes }, as: :json
        }.to change(Shop, :count).by(0)
      end

      it "renders a JSON response with errors for the new shop" do
        post shops_url,
             params: { shop: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested shop" do
        shop = Shop.create! valid_attributes
        patch shop_url(shop),
              params: { shop: new_attributes }, headers: valid_headers, as: :json
        shop.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested shop" do
      shop = Shop.create! valid_attributes
      expect {
        delete shop_url(shop), headers: valid_headers, as: :json
      }.to change(Shop, :count).by(-1)
    end
  end
end
